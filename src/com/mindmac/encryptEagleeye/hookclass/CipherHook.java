...
public class CipherHook extends MethodHook {
	...
	public static List<MethodHook> getMethodHookList() {
		...
		methodHookList.add(new CipherHook(Methods.getIV));
	...
	private void logMsg(ArrayList<byte[]> plainByteList, ArrayList<byte[]> encryptByteList,
			int operationMode, String algorithm, int uid, String operation)
	{
...
//			operation = "decrypt";
		...
		for(int i=0; i<minSize; i++){
			...
			//plainText = new String(plainByteList.get(i));
			//encryptText = new String(encryptByteList.get(i));
	...
	public void after(MethodHookParam param) throws Throwable {
		...
		// Log message
		this.logMsg(plainByteList, encryptByteList, operationMode, algorithm, uid, operation);
