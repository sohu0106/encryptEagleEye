...
char* lib_path = "/data/data/com.mindmac.encryptEagleeye/lib/libeagleeyenative.so";

LIB_HOOK_INFO_NODE* custom_lib_hook_info_root = NULL;
HOOKED_INFO_NODE* hooked_info_root = NULL;

Java_com_mindmac_encryptEagleeye_NativeEntry_initSystemNativeHook( JNIEnv* env, jobject this )
{
...
Java_com_mindmac_encryptEagleeye_NativeEntry_initCustomNativeHook(JNIEnv* env, jobject this, jstring lib_name){
